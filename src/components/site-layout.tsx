...
export function PageHero({
  ...
  if (variant === "split" && image) {
    return (
      <section className="relative overflow-hidden gradient-soft">
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-12 md:py-20 lg:grid-cols-2 lg:items-center">
          <div>
  ...
  return (
    <section className="relative isolate overflow-hidden gradient-teal-deep text-white">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-12 md:py-20 text-center">
